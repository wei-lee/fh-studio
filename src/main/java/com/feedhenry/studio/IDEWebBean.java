...
//      }
  ...
  public JSONObject getProps() throws Exception {
    return mStudioProps.getJSONObject("serverProps");
  }

  public String getProperty(String pPropName) throws Exception {
    return getProps().getString(pPropName);
  }
