...
//      }
  ...
  public String getEmail() {
    String email = mUC.getString("email");
    return email;
  }

  public String getAccountType() {
    String accountType = mUC.getString("accountType");
    return accountType;
  }
