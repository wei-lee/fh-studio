App.Model.DomainStartupsPlatform = Backbone.Model.extend({
...
App.Collection.DomainStartupsPlatform = App.Collection.Metrics.extend({
  model: App.Model.DomainStartupsPlatform,
