App.Model.DomainInstallsPlatform = Backbone.Model.extend({
...
App.Collection.DomainInstallsPlatform = App.Collection.Metrics.extend({
  model: App.Model.DomainInstallsPlatform,
