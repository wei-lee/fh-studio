proto.Wizard = {
  ...
  showNextButton: function (el) {
    el.find('.jw-button-next').show();
  },
  ...
  hideNextButton: function (el) {
    el.find('.jw-button-next').hide();
  },
  ...
  getWizards: function() {
    ...
    var wizards = {
      ...
      windowsphone_export_wizard: ['app_export_windowsphone_versions', 'app_export_windowsphone_progress'],
      windowsphone_publish_wizard: ['app_publish_windowsphone_versions', 'app_publish_windowsphone_progress'],
