proto.Wizard = {
  ...
  load: function (wizard_id, jq_overrides, fh_overrides) {
    ...
    el.find('*[config-radio]').each(function () {
      ...
      try {
        ...
        Log.append('could not apply config for ' + parent.attr('config-radio') + ' :: ' + e.toString(), 'ERROR');
      }
  ...
  getWizards: function() {
    ...
    var wizards = {
      ...
      iphone_export_wizard: ['app_export_iphone_versions', 'app_export_iphone_progress'],
      ...
      ipad_export_wizard: ['app_export_ipad_versions', 'app_export_ipad_progress'],
      ...
      ios_export_wizard: ['app_export_ios_versions', 'app_export_ios_progress'],
    ...
    if ($fw.client.app.isNodeJsApp()) {
      Log.append('Node.js based app, applying wizard changes');
