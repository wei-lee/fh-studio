var Lang = {
  ...
  app_publish_iphone_versions_title: 'Please select the iOS deployment target version',
  ...
  app_publish_ipad_versions_title: 'Please select the iOS deployment target version',
  ...
  snippets_search_header: 'Search All Snippets',
  snippets_tags_header: 'Browse Snippets By Tag',
  snippets_mine_header: 'Manage My Snippets',
  snippet_details_name: 'Name',
  snippet_details_description: 'Description',
  snippet_details_tags: 'Tags',
  snippet_details_code: 'Code',
  snippet_details_shared: 'Shared',
  snippets_mine_snippets_new_button: 'New Snippet',
  snippets_mine_snippet_view_save_update_button: 'Update',
  snippets_mine_snippet_view_save_create_button: 'Create Snippet',
  snippets_search_page_button: 'Search',
  snippets_search_view_copy_snippet_button: 'Select Code',
  snippets_tags_list_snippet_view_copy_snippet_button: 'Select Code',
  snippets_mine_snippet_view_back_button: 'Back',
  snippets_mine_snippet_create_back_button: 'Back',
  snippets_search_view_back_button: 'Back',
  snippets_tags_list_snippets_back_button: 'Back',
  snippets_tags_list_snippet_view_back_button: 'Back',
  snippet_tags_name: 'Tag Name',
  snippet_tags_num: 'No. Snippets',
  ...
  arm_apps_grid_columns: ['Id', 'Name', 'Description', 'Manage'],
  arm_users_grid_columns: ['Id', 'Name', 'Email', 'Number of Groups', 'Number of Apps', 'Number of Devices', 'Manage'],
  arm_groups_grid_columns: ['Id', 'Name', 'Description', 'Number of Users', 'Number of Apps', 'Manage'],
  arm_devices_grid_columns: ['Id', 'Unique Id', 'Description', 'Make', 'Model', 'Manage'],
  ...
  armusers_edit_header: 'Edit User Details',
  armusers_edit_email_label: 'User Email',
  armusers_edit_name_label: 'User Name',
  armusers_edit_enabled_label: 'User Enabled',
  armusers_assigngroups_header: 'Assign Groups To User',
  armusers_groups_grid_columns: ['Id', 'Group Name', 'Description', 'Select'],
  armusers_assignapps_header: 'Assign  Apps To User',
  armusers_apps_grid_columns: ['Id', 'App Name', 'Description', 'Select'],
  armusers_assigndevices_header: 'Assign Devices To User',
  armusers_devices_grid_columns: ['Id', 'Device Id', 'Make', 'Model', 'Descrption', 'Select'],
  delete_arm_confirm_text: 'The <TYPE> \'<ID>\' will be permanently deleted and cannot be recovered. Are you sure?',
  armusers_resetpass_header: 'Reset User Password',
  armusers_resetpass_old_password_label: 'Old Password',
  armusers_resetpass_new_password_label: 'New Password',
  armusers_resetpass_confirm_new_password_label: 'Confirm New Password',
  armgroups_edit_header: 'Edit Group Details',
  armgroups_edit_id_label: 'Group Id',
  armgroups_edit_name_label: 'Group Name',
  armgroups_edit_desc_label: 'Group Description',
  armgroups_assignusers_header: 'Assign Users To Group',
  armgroups_assignapps_header: 'Assign Apps To Group',
  armgroups_users_grid_columns: ['Id', 'User Email', 'User Name', 'Select'],
  armgroups_apps_grid_columns: ['Id', 'App Name', 'Description', 'Select'],
  armdevices_edit_header: 'Edit Device Details',
  armdevices_edit_id_label: 'Device Id',
  armdevices_edit_desc_label: 'Device Desciption',
  armdevices_edit_make_label: 'Device Make',
  armdevices_edit_model_label: 'Device Model',
  armdevices_edit_enabled_label: 'Device Enabled',
  armdevices_edit_blocked_label: 'Device Blocked',
  ...
  installsdate_radio_dest_label: 'Per Destination',
  ...
  startupsdate_radio_dest_label: 'Per Destination',
