var Lang = {
  ...
  app_publish_cordova_versions_info_text: ['Please choose which version of Cordova to use.', '<br />You can use third party Cordova plugins when build the app using Cordova 3 and above. Please see <a href="http://docs.feedhenry.com/v2/cordova_plugins.html" target="_blank">docs page</a> for more details.'],
  ...
  "system_logs_helper_text" : "See the details of all the events that are generated by the system for this app.",
  "alerts_helper_text": "You can get email notifications (alert) when certain events occur. You can manage the alert options here.",
  "notifications_helper_text": "See the details of all the email notifications that are already sent for this app.",

  "input_Timestamp_label_help_icon" : "The time when the event happened",
  "input_Event Category_label_help_icon" : "The type of the event",
  "input_Event Name_label_help_icon" : "The name of the event",
  "input_Severity_label_help_icon" : "The severity level of the event",
  "input_Message_label_help_icon" : "Extra messages about the event",
  "input_Target_label_help_icon" : "The deployment target",
  "input_Error_label_help_icon" : "Error details about the event",
  "input_EnvVars_label_help_icon" : "The updated environment variables",
  "input_Stacktrace_label_help_icon" : "The stacktrace infomation about the event",
  "input_Repo_label_help_icon" : "The Git repo URL of the app",
  "input_Branch_label_help_icon" : "The Git branch name of the app",
  "input_Commit_label_help_icon" : "The lastest Git commit hash when the event happened",
  "input_Approver_label_help_icon" : "The person who approved the deployment",
  "input_Comment_label_help_icon" : "The approver's comment about the deployment",
  "alert_name_label_help_icon" : "The name of the alert. It should be unique for this app.",
  "alert_categories_label_help_icon" : "This alert will be triggered if an event matches the specified categories, severities and names occurs. Leave blank for any event category.",
  "alert_severities_label_help_icon" : "This alert will be triggered if an event matches the specified categories, severities and names occurs. Leave blank for any level of severity.",
  "alert_event_names_label_help_icon" : "This alert will be triggered if an event matches the specified categories, severities and names occurs. Leave blank for any event name. The options will be filtered based on the values in Event Categories and Severities.",
  "alert_emails_label_help_icon" : "The recipients of the alert. Use comma to separate multiple email addresses.",
  "alert_notification_ts_label_help_icon": "The time when the notification email was sent",
  "alert_notification_alert_name_label_help_icon": "The name of the alert that was triggered",
  "alert_notification_recipients_label_help_icon":"The recipients of the notification email",
  "alert_notification_subject_label_help_icon":"The subject of the notification email",
  "alert_notification_body_label_help_icon":"The content body of the notification email"
};