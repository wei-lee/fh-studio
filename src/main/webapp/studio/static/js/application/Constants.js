...
$.extend(Constants, {
  ...
  CMS_ENABLE_URL : Constants.MBAAS_URL_PREFIX + "admin/enableCms",
  ...
  ENVIRONMENT_TARGET_CREATE_URL : Constants.ENVIRONMENT_TARGET_MANAGE_PREFIX + "create",
  ENVIRONMENT_TARGET_READ_URL : Constants.ENVIRONMENT_TARGET_MANAGE_PREFIX + "read",
  ENVIRONMENT_TARGET_LISTFORAPP_URL : Constants.ENVIRONMENT_TARGET_MANAGE_PREFIX + "list",
  ENVIRONMENT_TARGET_LIST_DEPLOYED_URL : Constants.ENVIRONMENT_TARGET_MANAGE_PREFIX + "listDeployed",
