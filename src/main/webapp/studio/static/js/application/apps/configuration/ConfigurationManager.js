application.ConfigurationManager = Class.extend({
  ...
  show: function () {
    var self = this;
    log('show config for ' + self.destination);
  ...
  showPost: function () {
    var self = this;
    log("Get configration for : " + self.destination);
    ...
    log("container = " + '#configuration_' + self.destination + '_form');
