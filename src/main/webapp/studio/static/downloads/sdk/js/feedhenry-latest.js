 ...
 *
 *  version 0.6.1
 *  http://brian.io/lawnchair/downloads/lawnchair-0.6.1.js
 */
...
Lawnchair.adapter('localFileStorage', (function () {
  // private methods
  var fail = function (e, i) { if(console && console.error) console.error("localFileStorage error " + e);};
      ...
      self.getDataSet(dataset_id, function(dataset) {
        ...
        Lawnchair(function (){
          this.fail = function (err){
            var errMsg = 'save to local storage failed err:' + err;
            self.doNotify(dataset_id, null, self.notifications.CLIENT_STORAGE_FAILED, errMsg);
            self.consoleLog(errMsg);
          };
          this.save({key:"dataset_" + dataset_id,val:JSON.stringify(dataset)}, function (ok){
...
//        });
    ...
    loadDataSet: function (dataset_id, success, failure) {
      ...
      Lawnchair(function (){
        this.fail = function (err){
          var errMsg = 'load from local storage failed  msg:' + err;
          self.doNotify(dataset_id, null, self.notifications.CLIENT_STORAGE_FAILED, errMsg);
          self.consoleLog(errMsg);
        };
