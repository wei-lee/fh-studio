...
/* CUSTOM CODE:DM Initialise Editor and StopIteration as this parser is 
   only used for syntax highlighting, not in an editor
 */
Editor = {};
StopIteration = {toString: function() {return "StopIteration"}};
// indentUnit value shouldn't matter when only highlighting so value can be anything
var indentUnit = 2;
