/*to reduce the number of http requests, merge serveral files together here:
 * util.js, stringstream.js, select.js, undo.js, editor.js, tokenize.js, tokenizejavascipt.js, parsejavascript.js,
 * parsecss.js, parsehtmlmixed.js, parsedummy.js, parsexml.js
 * */
  ...
  function Editor(options) {
    ...
    if (!options.readOnly) {
      ...
      addEventHandler(document.body, "paste", function(event) {
        ...
        if(self.options.editFunction && typeof self.options.editFunction == "function"){
          self.options.editFunction();
        }
      });
  ...
  Editor.prototype = {
    ...
    keyDown: function(event) {
      ...
      // Only in Firefox is the default behavior for PgUp/PgDn correct.
        ...
        else if (code == 70 && this.options.searchFunction) { // F
          this.options.searchFunction();
          event.stop();
        }
        else if (code == 76 && this.options.lineFunction) { // L
          this.options.lineFunction();
          event.stop();
        }
        else if (code == 86){ // V (paste)
          if(this.options.editFunction){
            this.options.editFunction();
          }   
        }
        ...
        if (this.options.editFunction && (code>7 && code<14) || (code >46 && code<91) || (code>93 && code<112) || (code>185 && code<222) || code == 32){
          this.options.editFunction();
        }
      }
      
      if(edited && this.options.editFunction){
          this.options.editFunction();
      }
