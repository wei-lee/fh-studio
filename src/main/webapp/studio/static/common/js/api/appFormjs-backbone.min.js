...
// NOTE: validate plugin has a 'phoneUS' type. Could use this if needed
  ...
  var FormView = BaseView.extend({
    ...
    "fieldValue": [],
    templates: {
      buttons: '<div id="buttons" class="fh_action_bar fh_appform_navigation"><button class="saveDraft hide button button-main fh_appform_button_action">Save Draft</button><button class="previous hide button fh_appform_button_navigation">Previous</button><button class="next hide button fh_appform_button_navigation">Next</button><button class="submit hide button button-positive fh_appform_button_action">Submit</button></div>'
    },
    events: {
    ...
    checkPages: function() {
      if (this.pageNum === 0 && this.pageNum === this.pageCount - 1) {
        this.el.find("#buttons > button.previous").hide();
        this.el.find("#buttons button.next").hide();
        this.el.find("button.saveDraft").show();
        this.el.find(" button.submit").show();
        this.el.find("button").addClass('two_button');
      } else if (this.pageNum === 0) {
        this.el.find(".fh_appform_navigation > .previous").hide();
        this.el.find(".fh_appform_navigation > .next").show();
        this.el.find(".fh_appform_navigation > .saveDraft").show();
        this.el.find(".fh_appform_navigation > .submit").hide();
        this.el.find(".fh_appform_navigation > button").addClass('two_button');
